...
* False: use the existing CPU charge mixing path.)";
        ...
        item.unit = "";
        item.availability = "Only effective for CUDA plane-wave reciprocal charge mixing with GPU-resident charge "
                            "density. The GPU-resident path supports plain, Broyden, and Pulay mixing for nspin=1, "
                            "nspin=2, and traditional nspin=4 mixing_angle<=0, including double-grid and tau-mixing "
                            "cases. Noncollinear angle mixing uses the existing CPU charge mixing path.";
