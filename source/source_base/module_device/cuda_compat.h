...
// NVTX header for CUDA versions prior to 12.0 vs. 12.0+
// This block ensures the correct NVTX header path is used based on CUDA_VERSION.
// - For CUDA Toolkit < 12.0, the legacy header "nvToolsExt.h" is included.
// - For CUDA Toolkit >= 12.0, the modern header "nvtx3/nvToolsExt.h" is included,
// which is header-only and preferred.
// See:
